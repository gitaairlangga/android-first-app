...
class DayInfoWidget extends StatelessWidget {
        ...
        Column(
          ...
          children: [
            ...
            trackedDay != null
                ...
                : const SizedBox(),
            const SizedBox(height: 8.0),
            stepsCounterContainer(context, stepstaken, kcalStepsBurned),
            const SizedBox(height: 4.0),
  ...
  String _getCaloriesTrackedDisplayString(TrackedDayEntity trackedDay) {
    ...
    return '$caloriesTracked/${trackedDay.calorieGoal.toInt() + kcalStepsBurned.toInt()} kcal';
  }
  ...
  Widget stepsCounterContainer(BuildContext context, int totalStepStaken, double kcalBurned){
    return Padding(
                    ...
                    children: <Widget>[
                      ...
                      Row(
                        children: [
                          ...
                          SizedBox(
                            // width: 120,
                            child: Text("🔥", style: Theme.of(context).textTheme.bodyLarge?.copyWith(
                                color: Theme.of(context).colorScheme.onSurface)),
                          ),
                          const SizedBox(width: 10),
                          SizedBox(
                            width: 120,
                            child: Text("${kcalBurned.toStringAsFixed(2)} kcal", style: Theme.of(context).textTheme.bodyLarge?.copyWith(
                                color: Theme.of(context).colorScheme.onSurface)),
                          ),
                        ],
                      ),
