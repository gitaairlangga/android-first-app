...
class HiveDBProvider extends ChangeNotifier {
  ...
  static const stepsCounterBoxName = 'StepsCounterBox';
  ...
  late Box<StepsCounterDbo> stepsCounterBox;
  ...
  Future<void> initHiveDB(Uint8List encryptionKey) async {
    ...
    Hive.registerAdapter(StepsCounterDboAdapter());
    ...
    trackedDayBox = await Hive.openBox(trackedDayBoxName,
        encryptionCipher: encryptionCypher);
    stepsCounterBox = await Hive.openBox(stepsCounterBoxName,
        encryptionCipher: encryptionCypher);
  }
