...
Future<void> initLocator() async {
  ...
  locator.registerLazySingleton<AddStepsCounterUsecase>(
          () => AddStepsCounterUsecase(locator()));
  locator.registerLazySingleton<GetStepsCounterUsecase>(
          () => GetStepsCounterUsecase(locator()));
  ...
  locator.registerLazySingleton<StepsCounterRepository>(
        () => StepsCounterRepository(locator()));
  ...
  locator.registerLazySingleton(
          () => StepsCounterDataSource(hiveDBProvider.stepsCounterBox));
